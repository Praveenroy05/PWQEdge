...
- Name: Add the product to the cart validation for ADIDAS ORIGINAL
- Location: C:\Users\prave\OneDrive\Documents\Praveen-PW\QEdgePWMay\tests\DPDDTest.spec.ts:29:5
...
Call log:
  - waiting for locator('div.card-body').nth(1).getByText('Add To Cart')
    - locator resolved to <button _ngcontent-kgn-c34="" class="btn w-10 rounded">…</button>
  - attempting click action
    ...
    at C:\Users\prave\OneDrive\Documents\Praveen-PW\QEdgePWMay\tests\DPDDTest.spec.ts:33:5
```
