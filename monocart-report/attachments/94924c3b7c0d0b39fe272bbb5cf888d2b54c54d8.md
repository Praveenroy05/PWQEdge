...
- Name: Add the product to the cart validation for ZARA COAT 3
...
Call log:
  - waiting for locator('div.card-body').first().getByText('Add To Cart')
    - locator resolved to <button _ngcontent-cgn-c34="" class="btn w-10 rounded">…</button>
