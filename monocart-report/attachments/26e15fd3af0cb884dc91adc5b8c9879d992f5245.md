...
- Name: Drop down developed using non select tag handling
- Location: C:\Users\prave\OneDrive\Documents\Praveen-PW\QEdgePWMay\tests\dropDown.spec.ts:46:5
...
Call log:
  - waiting for locator('#react-select-4-option-2')

    at C:\Users\prave\OneDrive\Documents\Praveen-PW\QEdgePWMay\tests\dropDown.spec.ts:54:59
```
...
- text: Select Value Group 1, option 2
- textbox
