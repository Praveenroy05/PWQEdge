...
Call log:
  - navigating to "https://practice.expandtesting.com/dropdown", waiting until "load"

    at C:\Users\prave\OneDrive\Documents\Praveen-PW\QEdgePWMay\tests\dropDown.spec.ts:32:16
```
...
- main:
  ...
  - heading "Dropdown List page for Automation Testing Practice" [level=1]
  - paragraph: You can use this Dropdown page for practicing test automation with Selenium or other tools like Playwright, Cypress, etc.
  - heading "Simple dropdown" [level=2]
  - combobox:
    - option "Please select an option" [disabled] [selected]
    - option "Option 1"
    - option "Option 2"
  - heading "Select your date of birth" [level=2]
  - text: "Elements per Page:"
  - combobox "Elements per Page:":
    - option "10" [selected]
    - option "20"
    - option "50"
    - option "100"
  - heading "Country selection" [level=2]
  - paragraph:
    - combobox:
...
- insertion:
  - iframe
- img
- link "Go to shopping options for Test Automation E-book": Test Automation E-book
...
> 32 |     await page.goto("https://practice.expandtesting.com/dropdown")
  ...
  44 |
  45 |
  46 | test.skip('Drop down developed using non select tag handling', async ({page})=>{
